...
def loading():
    with open('C:\\Users\\32118\\OneDrive\\文档\\PythonUI\\scLLMmaster\\model\\gene_token_mapping.json', 'r') as f:
        gene_token_mapping = json.load(f)

    with open('C:\\Users\\32118\\OneDrive\\文档\\PythonUI\\scLLMmaster\\model\\expression_mapping.json', 'r') as f:
        expression_mapping = json.load(f)
    
    with open('C:\\Users\\32118\\OneDrive\\文档\\PythonUI\\scLLMmaster\\model\\label_mapping.json', 'r') as f:
